...
export default function Footer() {
  return (
    <footer className="bg-[#2C2826] text-[#EDE8DC]">
      <div className="container-max py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Nav */}
          <div>
            <p className="text-xs uppercase tracking-widest text-[#7A9E80] font-medium mb-4">
              Navigate
            </p>
            <nav className="flex flex-col gap-2">
              {footerLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-sm text-[#9A9590] hover:text-white transition-colors"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="text-[#9A9590] hover:text-[#7A9E80] transition-colors"
              >
                <InstagramIcon />
              </a>
              <a
        ...
        <div className="mt-12 pt-8 border-t border-[#6B6460]/30 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[#9A9590]">
            &copy; {new Date().getFullYear()} altogetherceremonies &mdash; Jane
            Wingfield. All rights reserved.
          </p>
          <p className="text-xs text-[#9A9590]">
